...
Adapted from: https://github.com/sigstore/sigstore-js/blob/main/packages/core/src/asn1/length.ts
Changes: Buffer → Uint8Array for browser compatibility, added .js extensions
*/
