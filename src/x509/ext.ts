...
Adapted from: https://github.com/sigstore/sigstore-js/blob/main/packages/core/src/x509/ext.ts
Changes: Buffer → Uint8Array, added Fulcio issuer extension classes (V1 & V2)
*/
